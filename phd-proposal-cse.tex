...
\paragraph{Diagnostic Support}{If the previous components are successfully implemented and evaluated in a modest time, the architecture could be extended to include a diagnostic support component.

...
\paragraph{Integration of the architecture in a real medical workflow}{A core focus of this project is ensuring high potential for real-world clinical adoption. In order to ensure that, standard formats will be used (ICD-O-3 and TNM) and the framework must remains generic and extendible.
